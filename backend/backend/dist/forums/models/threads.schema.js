...
__decorate([
    (0, mongoose_1.Prop)({ type: mongoose_2.default.Schema.Types.ObjectId, ref: 'ForumPost', required: true }),
    __metadata("design:type", mongoose_2.default.Types.ObjectId)
], Thread.prototype, "forumId", void 0);
__decorate([
    (0, mongoose_1.Prop)({ type: [{ type: mongoose_2.default.Schema.Types.ObjectId, ref: 'Reply' }] }),
